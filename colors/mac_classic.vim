...
" StatusLine: {{{2
hi StatusLine  guifg=#EFEFEF ctermfg=0 guibg=#7f3f00 ctermbg=189 gui=NONE
hi StatusLineNC  guifg=#EFEFEF ctermfg=0 guibg=#999999 ctermbg=7 gui=NONE
...
hi Comment  guifg=#0066FF ctermfg=27 gui=NONE
...
hi Todo  guifg=#0066FF ctermfg=27 gui=inverse,bold
